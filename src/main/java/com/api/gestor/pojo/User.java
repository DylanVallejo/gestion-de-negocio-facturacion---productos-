...
//@NamedQuery(name = "User.getAllAdmins", query = "select new com.api.gestor.wrapper.UserWrapper(u.id,u.nombre, u.email, u.numero_de_contacto, u.status) from User u where u.role='admin'")
